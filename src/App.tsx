...
const App: React.FC = () => {
  ...
  const showApp = session && profileComplete && !profileFetching;
                ...
                <main className="flex-grow container mx-auto">
                  ...
                  {activeTab === 'messages' && (
                    <div className="text-center py-40">
                       ...
                       <p className="text-mat-slate/40 text-xs uppercase tracking-widest mt-4">Coming Soon: Deep Connections in Turso</p>
                    </div>
                  )}
                  {activeTab === 'profile' && (
                          ...
                          {isEditing && profile ? (
                            ...
                            >
                               ...
                               <div className="relative group">
                                  ...
                                  <Tooltip content="Refine Visual Narrative">
                                     <button 
                                        onClick={() => setIsEditing(true)}
                                        className="absolute -top-3 -right-3 w-10 h-10 bg-mat-rose text-mat-cream rounded-xl flex items-center justify-center shadow-mat-rose hover:scale-110 transition-transform hover:bg-mat-rose-deep"
                                     >
                                        <Camera size={16} />
                                     </button>
                                  </Tooltip>
