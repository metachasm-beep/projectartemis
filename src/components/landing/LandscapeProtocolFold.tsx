    ...
    <Fold id="landscape-protocol" className="bg-mat-cream border-t border-black/5 py-0 overflow-hidden">
      <div ref={containerRef} className="h-full flex flex-col justify-center space-y-8 lg:space-y-12 py-12">
        <div className="space-y-4 flex flex-col items-center md:items-start text-center md:text-left">
          <motion.span 
            className="px-4 py-1 border border-mat-gold/10 uppercase tracking-[0.4em] font-black text-[9px] bg-mat-gold/5 text-mat-wine rounded-none inline-block"
          >
            The Distinction
          </motion.span>
          <motion.h2 
          ...
          >
            Chaos vs <span className="text-mat-gold/20 italic">Order</span>
          </motion.h2>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 border border-mat-gold/10 p-1">
          <div className="bg-mat-ivory/40 p-10 space-y-8 border border-mat-gold/5">
            ...
            <div className="space-y-4 pt-2">
              {["Endless swiping loops", "Low-intent matches", "Chaotic inboxes", "Fake data scarcity", "No real feminine control"].map(item => (
                <div key={item} className="flex items-center gap-3 text-mat-slate/40 group">
          ...
          <div className="bg-mat-ivory p-10 space-y-8 border border-mat-gold/20 relative overflow-hidden shadow-xl">
            {/* Ambient Gold Glow */}
            ...
            <h2 className="text-3xl md:text-5xl font-display text-mat-slate uppercase leading-tight relative z-10">
            ...
            <div className="space-y-4 pt-2 relative z-10">
              {["Female-controlled matching", "Curated male visibility", "Deliberate discovery", "Structured communication", "Premium trust and safety"].map(item => (
                <div key={item} className="flex items-center gap-3 text-mat-slate/80">
